...
app_server <- function(input, output, session) {
  ...
  colnames(pathway2name) <- c("path_id", "path_name")
  observeEvent(input$view_uploadhmp_exm,{
    output$hmp_exm <- renderDT({
      ...
      else if(input$uploadhmp_exm == "FALSE"){
        hmpdata <- reactive({
          req(input$uploadhmp)
          data <- read.delim(input$uploadhmp$datapath,
                             header = T,
                             check.names = F)
          return(data)
          })}
  ...
  observeEvent(input$structural_analyse,{
    ...
    withProgress(message = "Calculating",
                 ...
                 expr = {
                   ...
                   hmp_num <- reactive(GAPIT(G = hmpdata(),
                                             output.numerical = F,
                                             file.output = F)
                                       )
                   treedata <- hmp_num()$GD
        ...
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if (input$tree_farmat == "jpeg"){
                         jpeg(file,
                              height = input$tree_height,
                              width = input$tree_width,
                              units = "in",
                              res = 800)
                       }
        ...
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if (input$PCA_plot_2D_farmat == "jpeg"){
                         jpeg(file,
                              height = input$PCA_plot_2D_height,
                              width = input$PCA_plot_2D_width,
                              units = "in",
                              res = 800)
                       }
        ...
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if (input$PCA_plot_3D_farmat == "jpeg"){
                         jpeg(file,
                              height = input$PCA_plot_3D_height,
                              width = input$PCA_plot_3D_width,
                              units = "in",
                              res = 800)
                         }
                       else if (input$PCA_plot_2D_farmat == "pdf"){
  ...
  observeEvent(input$view_uploadpheno_exm,{
    output$pheno_exm <- renderDT({
      ...
      else if(input$uploadpheno_exm == "FALSE"){
        phenodata <- reactive({
          req(input$uploadpheno)
          data <- read.delim(input$uploadpheno$datapath,
                             header = T,
                             check.names = F,
                             sep = "\t")
          return(data)
  ...
  observeEvent(input$Calblup,{
    ...
    output$download_histplot <- downloadHandler(
      filename = function(){
        paste0("HistPlot_Mean.",
               input$Histplot_faormat,
               sep = "")
      },
      content = function(file){
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if (input$Histplot_faormat == "jpeg"){
                         jpeg(file,
                              height = input$Histplot_height,
                              width = input$Histplot_width,
                              units = "in",
                              res = 800)
                       }
  ...
  observeEvent(input$view_Uploadtraits_exm,{
    output$traits_exm <- renderDT({
      ...
      else if(input$Uploadtraits_exm == "FALSE"){
        traitdata <- reactive({
          req(input$Uploadtraits)
          traitdata <- read.delim(input$Uploadtraits$datapath,
                                  header = T,
                                  check.names = F)
          return(traitdata)
        })}
  ...
  observeEvent(input$Cal_corr,{
    if(input$Uploadtraits_exm == "TRUE"){
      ...
      traitdata <- reactive({
        req(input$Uploadtraits)
        traitdata <- read.table(input$Uploadtraits$datapath,
                                header = T,
                                row.names = 1,
                                check.names = F)
        traitdata_clean <- na.omit(traitdata)
    ...
    withProgress(message = "Calculating",
                 ...
                 expr = {
                   ...
                   trait_cor <- reactive(cor(traitdata(),
                                             method = Cormethod))
      ...
      content = function(file){
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if (input$Cor_heatmap_format == "jpeg"){
                         jpeg(file,
                              height = input$Cor_heatmap_height,
                              width = input$Cor_heatmap_width,
                              units = "in",
                              res = 800)
                       }
                       else if (input$Cor_heatmap_format == "pdf"){
                         pdf(file,
                             height = input$Cor_heatmap_height,
                             width = input$Cor_heatmap_width)
                       }
                       else if (input$Cor_heatmap_format == "png"){
                         png(file,
                             height = input$Cor_heatmap_height,
                             width = input$Cor_heatmap_width,
                             units = "in",
                       ...
                       else if (input$Cor_heatmap_format == "svg"){
                         svg(file,
                             height = input$Cor_heatmap_height,
                             width = input$Cor_heatmap_width)
                       }
                       else if (input$Cor_heatmap_format == "tiff"){
                         tiff(file,
                              height = input$Cor_heatmap_height,
                              width = input$Cor_heatmap_width,
                              units = "in",
      ...
      content = function(file){
        withProgress(
          ...
          expr = {
            ...
            else if(input$Hcluster_format == "pdf"){
              pdf(file,
                  height = input$Hcluster_height,
                  width = input$Hcluster_width)
            }
            else if(input$Hcluster_format == "png"){
              png(file,
                  height = input$Hcluster_height,
                  width = input$Hcluster_width,
                  units = "in",
            ...
            else if(input$Hcluster_format == "svg"){
              svg(file,
                  height = input$Hcluster_height,
                  width = input$Hcluster_width)
            }
  ...
  observeEvent(input$view_UploadVolcano_exm,{
    output$Volcano_exm <- renderDT({
      ...
      else if(input$UploadVolcano_exm == "FALSE"){
        de_result <- reactive({
          req(input$UploadVolcano)
          de_result <- read.delim(input$UploadVolcano$datapath,
                                  header = T,
                                  sep = "\t",
                                  check.names = F)
          return(de_result)
  ...
  observeEvent(input$Volcano_plot,{
    if(input$UploadVolcano_exm == "TRUE"){
      ...
      de_result <- reactive({
        req(input$UploadVolcano)
        de_result <- read.delim(input$UploadVolcano$datapath, header = T,
                                sep = "\t",
                                check.names = F)
        return(de_result)
      })
        ...
        output$Volcano <- renderPlot(
          {
            EnhancedVolcano(de_result(),
                            ...
                            x = 'log2FoldChange',
                            y = 'pvalue',
                            xlim = c(input$Volcano_x_left,
                                     input$Volcano_x_right),
                            pCutoff = input$Volcano_p,
      ...
      content = function(file){
        withProgress(
          ...
          expr = {
            ...
            else if(input$Volcano_format == "pdf"){
              pdf(file,
                  height = input$Volcano_height,
                  width = input$Volcano_width)
            }
            else if(input$Volcano_format == "png"){
              png(file,
                  height = input$Volcano_height,
                  width = input$Volcano_width,
                  units = "in",
            ...
            else if(input$Volcano_format == "svg"){
              svg(file,
                  height = input$Volcano_height,
                  width = input$Volcano_width)
            }
            ...
            valocano <- EnhancedVolcano(de_result(),
                                        ...
                                        x = 'log2FoldChange',
                                        y = 'pvalue',
                                        xlim = c(input$Volcano_x_left, input$Volcano_x_right),
                                        pCutoff = input$Volcano_p,
                                        FCcutoff = input$Volcano_FC)
            plot(valocano)
            dev.off()
  ...
  observeEvent(input$view_Uploadheatmap_exm,{
    output$heatmap_exm <- renderDT({
      ...
      else if(Uploadheatmap_exm == "FALSE"){
        gene_expr <- reactive({
          req(input$Uploadheatmap)
          expr1 <- read.delim(input$Uploadheatmap$datapath,
                              header = T,
                              check.names = F)
          return(expr1)
        })
  ...
  observeEvent(input$heatmap_plot,{
    ...
    withProgress(
      message = "Calculating",
      detail = "It will take some time ^_^",
      expr = {
        for(i in 1:3){
          incProgress(1/3)
          Sys.sleep(0.5)
      ...
      content = function(file){
        withProgress(
          ...
          expr = {
            ...
            else if(input$heatmap_height == "png"){
              png(file,
                  height = input$heatmap_height,
                  width = input$heatmap_width,
                  units = "in",
  ...
  observeEvent(input$view_uploadgeno_exm,{
    output$geno_exm <- renderDT({
      ...
      else if(input$uploadgeno_exm == "FALSE"){
        GWAS_Geno <- reactive({
          req(input$uploadgeno)
          data <- read.delim(input$uploadgeno$datapath,
                             header = T,
                             check.names = F)
          return(data)
        })}
  ...
  observeEvent(input$view_uploadpheno_GWAS_exm,{
    output$pheno_GWAS_exm <- renderDT({
      ...
      }else if(input$uploadpheno_GWAS_exm == "FALSE"){
        GWAS_pheno <- reactive({
          req(input$uploadpheno_GWAS)
          data <- read.delim(input$uploadpheno_GWAS$datapath,
                             header = T,
                             check.names = F)
          return(data)
        })
      }
      datatable(GWAS_pheno(),
                extensions = 'Buttons',
                options = list(dom = 'lBfrtip',
                               scrollX = TRUE,
                               buttons = c('copy', 'csv', 'excel', 'pdf', 'print')
  ...
  observeEvent(input$RunGWAS, {
    ...
    withProgress(message = "Calculating",
                 ...
                 expr = {
                   ...
                   GWAS_Geno_num <- reactive(GAPIT(G = GWAS_Geno(),
                                                   output.numerical = F,
                                                   file.output = F))
                   PCA_num <- input$PCA_num
                   GWAS_model <- input$GWAS_model
                   GWAS_result <- GAPIT(Y = GWAS_pheno()[,c(1,2)],
                                        GD = GWAS_Geno_num()$GD,
                                        GM = GWAS_Geno_num()$GM,
                                        PCA.total = PCA_num,
                                        model = GWAS_model,
                   ...
                   GWAS_reslut_final <- dplyr::select(GWAS_result$GWAS, !(2:3)) %>%
                     left_join(GWAS_Geno_num()$GM,
                               by = c("SNP" = "SNP"))
                   output$GWASresult <- renderDT({
                     datatable(GWAS_reslut_final,
                               options = list(scrollX = TRUE))
                   })}
    )
        ...
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if (input$GWAS_table_format == "csv"){
                         write.csv(GWAS_reslut_final,
                                   file)
                       }
                       else if (input$GWAS_table_format == "tsv"){
                         write_tsv(GWAS_reslut_final,
                                   file)
                       }
                       else if (input$GWAS_table_format == "txt"){
                         write.table(GWAS_reslut_final,
                                     file)
                       }}
        )}
    )
          ...
          withProgress(message = "Downloading",
                       ...
                       expr = {
                         ...
                         if (input$QQ_farmat == "jpeg"){
                           jpeg(file,
                                height = input$QQ_height,
                                width = input$QQ_width,
                                units = "in",
                                res = 800)
                         }
      ...
      withProgress(message = "Drawing",
                   ...
                   expr = {
                     ...
                     output$Manhattan_plot <- renderPlotly({
                       p_GWAS_reslut_final <- ggplot(GWAS_reslut_final,
                                                     aes(x = Chromosome,
                                                         y = -log10(P.value)))+
        ...
        content = function(file){
          withProgress(message = "Downloading",
                       ...
                       expr = {
                         ...
                         p_Manhattan <- ggplot(GWAS_reslut_final,
                                               aes(x = Chromosome,
                                                   y = -log10(P.value)))+
    ...
    observeEvent(input$Extract, {
      ...
      withProgress(message = "Extracting",
                   ...
                   expr = {
                     ...
                     mygxf_df <- dplyr::filter(as.data.frame(mygxf()),
                                               type == "gene")
                     GWAS_reslut_final <- dplyr::select(GWAS_result$GWAS, !(2:3)) %>%
                       left_join(GWAS_Geno_num()$GM,
                                 by = c("SNP" = "SNP"))
                     Sig_p <- input$Significant_SNP
                     Sig_SNP <- dplyr::filter(GWAS_reslut_final,
                                              P.value <= Sig_p)
  ...
  observeEvent(input$view_uploadLDhmp_exm,{
    output$LDhmp_exm <- renderDT({
      ...
      else if(input$uploadLDhmp_exm == "FALSE"){
        LD_hmp <- reactive({
          req(input$uploadgeno)
  ...
  observeEvent(input$Plot_LD,{
    ...
    withProgress(message = "Drawing",
                 ...
                 expr = {
                   ...
                   LDSNPdata <- dplyr::filter(LD_hmp(),
                                              chrom == userchoice_chrom & pos >leftpos & pos < rightpos)
                   SNPdata <- dplyr::select(LDSNPdata, !(2:11))
                   SNPdata_t <- data.frame(t(SNPdata),
                                           row.names = NULL)
                   ...
                   SNPpos <- filter(LD_hmp(),
                                    chrom == userchoice_chrom & pos >leftpos & pos < rightpos) %>%
                     pull(pos)
                   color.rgb <- colorRampPalette(rev(c("orange", "red")),
                                                 space = "rgb")
                   output$LD_plot <- renderPlot({
                     LDheatmap(SNPdata_df,
                               SNPpos,
                               color = color.rgb(20),
                               flip = T,
                               SNP.name = colnames(SNPdata_df),
                               geneMapLocation = 0.1)
                   })}
    )
        ...
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if (input$LD_farmat == "jpeg"){
                         jpeg(file,
                              height = input$LD_height,
                              width = input$LD_width,
                              units = "in",
                              res = 800)
                       }
  ...
  observeEvent(input$view_UploadGeneInfo_exm,{
    output$GeneInfo_exm <- renderDT({
      ...
      else if(input$UploadGeneInfo_exm == "FALSE"){
        GeneInfo <- reactive({
          req(input$GeneInfo)
  ...
  observeEvent(input$view_UploadGeneList_exm,{
    output$GeneList_exm <- renderDT({
      ...
      }else if(input$UploadGeneList_exm == "FALSE"){
        gene_list <- reactive({
          req(input$GeneList)
  ...
  observeEvent(input$Run_GO, {
    ...
    withProgress(message = "Calculating",
                 ...
                 expr = {
                   ...
                   Gene_info <- dplyr::select(GeneInfo(),
                                              ...
                                              Pathway = Pathway,
                                              Gene_Name = GID)
                   gene2go <- dplyr::select(Gene_info,
                                            GID,
                                            GO) %>%
                     separate_rows(GO,
                                   sep = ',',
                   ...
                   GOTerms <- dplyr::select(as.data.frame(GOTERM),
                     ...
                     na.omit()
                   Go_class <- distinct(as.data.frame(GOTERM),
                                        go_id, Ontology,
                                        .keep_all =F)
                   ...
                   GO_result_ori1 <- go_rich@result %>%
                     left_join(Go_class,
                               by = c("ID" = "go_id"))
                   GO_result_ori2 <- dplyr::select(GO_result_ori1,
                                                   -c(p.adjust,
                                                      qvalue))
                   GO_result <- dplyr::filter(GO_result_ori2,
                                              pvalue <= GO_p)
    ...
    output$download_GO_table <- downloadHandler(
      filename = function(){
        paste0("GO_enrichment_result.",
               input$GO_table_format,
               sep = "")
      },
      content = function(file){
        withProgress(message = "Downloading",
    ...
    observeEvent(input$Plot_GO, {
      withProgress(message = "Drawing",
                   ...
                   expr = {
                     ...
                     GO_result_BP <- dplyr::filter(GO_result,
                                                   Ontology == "BP")
                     GO_result_CC <- dplyr::filter(GO_result,
                                                   Ontology == "CC")
                     GO_result_MF <- dplyr::filter(GO_result,
                                                   Ontology == "MF")
                     ...
                     GO_BP <- subset(GO_result,
                                     subset = (Ontology == "BP"))[1:BP_num,]
                     GO_CC <- subset(GO_result,
                                     subset = (Ontology == "CC"))[1:CC_num,]
                     GO_MF <- subset(GO_result,
                                     subset = (Ontology == "MF"))[1:MF_num,]
          ...
          withProgress(message = "Downloading",
                       ...
                       expr = {
                         ...
                         if (input$GO_farmat == "jpeg"){
                           jpeg(file,
                                height = input$GO_height,
                                width = input$GO_width,
                                units = "in",
                                res = 800)
                         }
    ...
    withProgress(message = "Calculating",
                 ...
                 expr = {
                   ...
                   Gene_info <- dplyr::select(GeneInfo(),
                                              ...
                                              Pathway = Pathway,
                                              Gene_Name = GID)
                   pathway2gene <- dplyr::select(Gene_info,
                                                 Pathway,
                                                 GID) %>%
                     separate_rows(Pathway,
                                   sep = ',',
                                   convert = F) %>%
                   ...
                   kegg_result_ori1 <- dplyr::select(kegg_rich@result,
                                                     -c(p.adjust,
                                                        qvalue))
                   kegg_result <- dplyr::filter(kegg_result_ori1,
                                                pvalue <= KEGG_p)
                   output$KEGG_result <- renderDT({
                     datatable(kegg_result,
                               options = list(scrollX = TRUE))
                   })}
    )
    output$download_KEGG_table <- downloadHandler(
      filename = function(){
        paste0("KEGG_enrichment_result.",
               input$KEGG_table_format,
               sep = "")
      },
      content = function(file){
        withProgress(message = "Downloading",
          ...
          withProgress(message = "Downloading",
                       ...
                       expr = {
                         ...
                         if (input$KEGG_farmat == "jpeg"){
                           jpeg(file, height = input$KEGG_height,
                                width = input$KEGG_width,
                                units = "in",
                                res = 800)
                         }
                         else if (input$KEGG_farmat == "pdf"){
                           pdf(file,
                               height = input$KEGG_height,
                               width = input$KEGG_width)
                         }
  ...
  observeEvent(input$view_Upload_pcadata_exm,{
    output$pcadata_exm <- renderDT({
      ...
      else if(input$Upload_pcadata_exm == "FALSE"){
        pcadata <- reactive({
          req(input$Upload_pcadata)
          data <- read.table(input$Upload_pcadata$datapath,
                             sep = "\t",
                             header = T,
                             check.names = F)
          return(data)
  ...
  observeEvent(input$view_Uploadpcadata_info_exm,{
    output$pcadata_info_exm <- renderDT({
      ...
      else if(input$Upload_pcadata_info_exm == "FALSE"){
        pcadata_info <- reactive({
          req(input$Upload_pcadata_info)
          data <- read.delim(input$Upload_pcadata_info$datapath,
                             header = F,
                             row.names = 1,
                             check.names = F)
          return(data)
  ...
  observeEvent(input$pca_plot,{
    ...
    withProgress(message = "Calculating",
                 ...
                 expr = {
                   ...
                   output$pca_tab <- renderDT({
                     datatable(pca_tab$loadings,
                               options = list(scrollX = TRUE))
                   })
                 })
    if(input$pca_type == "screeplot"){
      pca_pic <- screeplot(pca_tab)
    }
    else if(input$pca_type == "biplot"){
      pca_pic <- biplot(pca_tab)
    }
    else if(input$pca_type == "pairsplot"){
      pca_pic <- pairsplot(pca_tab)
    }
    else if(input$pca_type == "loadingsplot"){
      pca_pic <- plotloadings(pca_tab)
    }
    output$pca_plot <- renderPlot({
      plot(pca_pic)
    })
    output$download_pca_pic <- downloadHandler(
      filename = function(){
        paste0("PCA.", input$pca_type,
               ".",
               input$pca_pic_format,
               sep ="")
      },
      content = function(file){
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if(input$pca_pic_format == "jpeg"){
                         jpeg(file,
                              height = input$pca_pic_height,
                              width = input$pca_pic_width,
                              units = "in",
                              res = 800)
                       }
                       else if (input$pca_pic_format == "pdf"){
                         pdf(file,
                             height = input$pca_pic_height,
                             width = input$pca_pic_width)
                       }
                       else if (input$pca_pic_format == "png"){
                         png(file,
                             height = input$pca_pic_height,
                             width = input$pca_pic_width,
                             units = "in",
                       ...
                       else if (input$pca_pic_format == "svg"){
                         svg(file,
                             height = input$pca_pic_height,
                             width = input$pca_pic_width)
                       }
                       else if (input$pca_pic_format == "tiff"){
                         tiff(file,
                              height = input$pca_pic_height,
                              width = input$pca_pic_width,
                              units = "in",
    ...
    output$download_pca_tab <- downloadHandler(
      filename = function(){
        paste0("pca_loadings.",
               input$pca_tab_format,
               sep = "")
      },
      content = function(file){
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if(input$pca_tab_format == "csv"){
                         write.csv(pca_tab$loadings,
                                   file)
                       }
                       else if(input$pca_tab_format == "tsv"){
                         write_tsv(pca_tab$loadings,
                                   file)
                       }
                       else if(input$pca_tab_format == "txt"){
                         write.table(pca_tab$loadings,
                                     file)}
                       })}
      )})
  observeEvent(input$view_uploadppi_exm,{
    output$ppi_exm <- renderDT({
      ...
      else if(input$uploadppi_exm == "FALSE"){
        ppidata <- reactive({
          req(input$uploadppi)
          data <- read.delim(input$uploadppi$datapath,
                             header = T,
                             check.names = F)
          return(data)
        })}
  ...
  observeEvent(input$plot_ppi,{
    ...
    withProgress(message = "Drawing",
                 ...
                 expr = {
                   ...
                   sources <- ppidata() %>%
                     distinct(node1) %>%
                     rename(label = node1)
                   destinations <- ppidata() %>%
                     distinct(node2) %>%
                     rename(label = node2)
                   nodes <- full_join(sources,
                                      destinations,
                                      by = "label")
                   nodes <- nodes %>%
                   ...
                   ppi_net <- graph_from_data_frame( d = edges,
                                                     vertices = nodes,
                                                     directed = T )
                   deg <- igraph::degree(ppi_net, mode="all")
                   cols <- input$ppi_color
                   pal <- colorRampPalette(cols)(nrow(nodes))
                   V(ppi_net)$color <- pal[factor(V(ppi_net)$label)]
                   E(ppi_net)$width < -E(ppi_net)$weight/2
                   if(input$ppi_theme == "layout.auto"){
                     mylayout <- layout.auto
                   }
                   else if(input$ppi_theme == "layout.circle"){
                     mylayout <- layout.circle
                   }
                   else if(input$ppi_theme == "layout.davidson.harel"){
                     mylayout <- layout.davidson.harel
                   }
                   else if(input$ppi_theme == "layout.gem"){
                     mylayout <- layout.gem
                   }
                   else if(input$ppi_theme == "layout.graphopt"){
                     mylayout <- layout.graphopt
                   }
                   else if(input$ppi_theme == "layout.grid"){
                     mylayout <- layout.grid
                   }
                   else if(input$ppi_theme == "layout.grid.3d"){
                     mylayout <- layout.grid.3d
                   }
                   else if(input$ppi_theme == "layout.kamada.kawai"){
                     mylayout <- layout.kamada.kawai
                   }
                   else if(input$ppi_theme == "layout.lgl"){
                     mylayout <- layout.lgl
                   }
                   else if(input$ppi_theme == "layout.mds"){
                     mylayout <- layout.mds
                   }
                   else if(input$ppi_theme == "layout.random"){
                     mylayout <- layout.random
                   }
                   else if(input$ppi_theme == "layout.reingold.tilford"){
                     mylayout <- layout.reingold.tilford
                   }
                   else if(input$ppi_theme == "layout.sphere"){
                     mylayout <- layout.sphere
                   }
                   else if(input$ppi_theme == "layout.spring"){
                     mylayout <- layout.spring
                   }
                   else if(input$ppi_theme == "layout.star"){
                     mylayout <- layout.star
                   }
                   else if(input$ppi_theme == "layout.sugiyama"){
                     mylayout <- layout.sugiyama
                   }
                   else if(input$ppi_theme == "layout.svd"){
                     mylayout <- layout.svd
                   }
                   else if(input$ppi_theme == "layout_as_star"){
                     mylayout <- layout_as_star
                   }
                   else if(input$ppi_theme == "layout_as_tree"){
                     mylayout <- layout_as_tree
                   }
                   else if(input$ppi_theme == "layout_components"){
                     mylayout <- layout_components
                   }
                   else if(input$ppi_theme == "layout_in_circle"){
                     mylayout <- layout_in_circle
                   }
                   else if(input$ppi_theme == "layout_nicely"){
                     mylayout <- layout_nicely
                   }
                   else if(input$ppi_theme == "layout_on_grid"){
                     mylayout <- layout_on_grid
                   }
                   else if(input$ppi_theme == "layout_on_sphere"){
                     mylayout <- layout_on_sphere
                   }
                   else if(input$ppi_theme == "layout_randomly"){
                     mylayout <- layout_randomly
                   }
                   else if(input$ppi_theme == "layout_with_dh"){
                     mylayout <- layout_with_dh
                   }
                   else if(input$ppi_theme == "layout_with_drl"){
                     mylayout <- layout_with_drl
                   }
                   else if(input$ppi_theme == "layout_with_fr"){
                     mylayout <- layout_with_fr
                   }
                   else if(input$ppi_theme == "layout_with_gem"){
                     mylayout <- layout_with_gem
                   }
                   else if(input$ppi_theme == "layout_with_graphopt"){
                     mylayout <- layout_with_graphopt
                   }
                   else if(input$ppi_theme == "layout_with_kk"){
                     mylayout <- layout_with_kk
                   }
                   else if(input$ppi_theme == "layout_with_lgl"){
                     mylayout <- layout_with_lgl
                   }
                   else if(input$ppi_theme == "layout_with_mds"){
                     mylayout <- layout_with_mds
                   }
                   else if(input$ppi_theme == "layout_with_sugiyama"){
                     mylayout <- layout_with_sugiyama
                   }
                   output$ppi_plot <- renderPlot({
                     if(input$followdeg == "Yes"){
                       if(input$followdeg_name == "Yes"){
                         if(input$followdeg_name_size == "Yes"){
                           plot(ppi_net,
                                layout = mylayout,
                                vertex.size=deg,
                                vertex.label.cex = input$followdeg_name_size_num*0.01*deg,
                         ...
                         else if(input$followdeg_name_size == "No"){
                           plot(ppi_net,
                                layout = mylayout,
                                vertex.size=deg,
                                vertex.label.cex = input$followdeg_name_size_num_custom*0.1,
                                vertex.frame.color = "white",
                                edge.color="gray90",
                                edge.arrow.size=0.1,
                                edge.curved=0.1,
                       ...
                       else if(input$followdeg_name == "No"){
                         plot(ppi_net,
                              layout = mylayout,
                              vertex.size=deg,
                              vertex.label = "",
                     ...
                     else if(input$followdeg == "No"){
                       if(input$nofollowdeg_name == "Yes"){
                         plot(ppi_net,
                              layout = mylayout,
                              vertex.label.cex = input$nofollowdeg_name_size*0.1,
                              vertex.frame.color = "white",
                              edge.color="gray90",
                              edge.arrow.size=0.1,
                              edge.curved=0.1,
                       ...
                       else if(input$nofollowdeg_name == "No"){
                         plot(ppi_net,
                              layout = mylayout,
                              vertex.label = "",
                              vertex.frame.color = "white",
    ...
    output$download_ppi <- downloadHandler(
      filename = function(){
        paste0("PPI.",
               input$ppi_format,
               sep = "")
      ...
      content = function(file){
        withProgress(message = "Downloading",
                     ...
                     expr = {
                       ...
                       if (input$ppi_format == "jpeg"){
                         jpeg(file,
                              height = input$ppi_height,
                              width = input$ppi_width,
                              units = "in",
                              res = 800)
                       }
                       else if (input$ppi_format == "pdf"){
                         pdf(file,
                             height = input$ppi_height,
                             width = input$ppi_width)
                       }
                       else if (input$ppi_format == "png"){
                         png(file,
                             height = input$ppi_height,
                             width = input$ppi_width,
                             units = "in",
                       ...
                       else if (input$ppi_format == "svg"){
                         svg(file,
                             height = input$ppi_height,
                             width = input$ppi_width)
                       }
                       else if (input$ppi_format == "tiff"){
                         tiff(file,
                              height = input$ppi_height,
                              width = input$ppi_width,
                              units = "in",
